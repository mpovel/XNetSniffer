...
bool response = false;
    ...
    switch (cData[CALL_BYTE]){
        case 0xA0:              
            ...
            break;
        case 0x60:
                if (0x61==(cData[HEADER]){
                    if (0x01==cData[HEADER+1]){
                        linePos += sprintf(line+linePos,"BC All On");
                    } else if (0x00==cData[HEADER+1]){
                        linePos += sprintf(line+linePos,"BC All Off");
                    } 
                } else if (0x81==cData[HEADER]){
